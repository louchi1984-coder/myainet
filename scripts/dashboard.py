...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,700;1,800;1,900&display=swap" rel="stylesheet">
<style>
  :root{
  ...
  *,*::before,*::after{font-family:'Poppins',ui-sans-serif,system-ui,sans-serif!important}
  ...
  .title{font-family:Impact,"Arial Black","Avenir Next Condensed",sans-serif;font-size:clamp(38px,4.6vw,62px);font-weight:900;font-style:italic;line-height:1.1;padding-bottom:.06em;letter-spacing:-.02em;color:var(--paper);white-space:nowrap}
